...
### Validation ###
r = validate(data_graph = data_graph, shacl_graph = shapes_graph, ont_graph = ont_graph, inference='rdfs', abort_on_error=False, meta_shacl=True, advanced=True, debug=True)
